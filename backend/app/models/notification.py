...
class NotificationEventType(str, enum.Enum):
    ...
    LLM_BUDGET_CRITICAL = "LLM_BUDGET_CRITICAL"
    LLM_BUDGET_BLOCKED = "LLM_BUDGET_BLOCKED"
    LLM_LIMIT_REQUEST_SUBMITTED = "LLM_LIMIT_REQUEST_SUBMITTED"
    LLM_LIMIT_REQUEST_APPROVED = "LLM_LIMIT_REQUEST_APPROVED"
    LLM_LIMIT_REQUEST_DENIED = "LLM_LIMIT_REQUEST_DENIED"

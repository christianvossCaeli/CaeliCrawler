...
class HistoryDataPointCreate(BaseModel):
    ...
    value_label: Optional[str] = Field(None, description="Formatted value for display")
    ...
    source_url: Optional[str] = Field(None, description="Original URL where found")
...
class HistoryDataPointUpdate(BaseModel):
    ...
    value: Optional[float] = Field(None, description="The numeric value")
    value_label: Optional[str] = Field(None, description="Formatted value")
    annotations: Optional[Dict[str, Any]] = Field(None, description="Metadata")
    human_verified: Optional[bool] = Field(None, description="Mark as verified")
...
class DateRange(BaseModel):
    ...
    from_date: Optional[datetime] = Field(None, description="Start of range")
    to_date: Optional[datetime] = Field(None, description="End of range")
...
class HistoryStatistics(BaseModel):
    ...
    oldest_value: Optional[float] = Field(None, description="Oldest value")
    trend: str = Field(
        default="stable",
    ...
    change_absolute: Optional[float] = Field(
...
class HistoryQueryParams(BaseModel):
    ...
    tracks: Optional[List[str]] = Field(None, description="Filter by track keys")

/**
 * Tests for useResultsView composable
 */
...
vi.mock('@/services/api', () => ({
  ...
  adminApi: {
    ...
    verifyExtractedData: vi.fn().mockResolvedValue({ data: {} }),
    getDisplayConfig: vi.fn().mockResolvedValue({ data: {} }),
  },
}))
...
describe('useResultsView', () => {
  ...
  describe('helper functions', () => {
    it('getConfidenceColor should return correct colors', () => {
      const { getConfidenceColor } = useResultsView()
    ...
    it('getSeverityColor should return correct colors', () => {
      const { getSeverityColor } = useResultsView()
    ...
    it('getPriorityColor should return correct colors', () => {
      const { getPriorityColor } = useResultsView()

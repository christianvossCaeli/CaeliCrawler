/**
 * Shared formatting utilities for LLM budget components
 *
 * Provides consistent formatting for currency, percentages, dates,
 * and status colors across all LLM-related UI components.
 */
...
/**
 * Composable providing all LLM formatting utilities
 */
export function useLLMFormatting() {
  return {
    formatCurrency,
    formatPercent,

...
export const apiGroups: ApiGroup[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'GET', path: '/api/v1/data/stats/unverified-count', description: 'help.apiGroups.publicApi.endpoints.unverifiedCount' },
      ...
      { method: 'PUT', path: '/api/v1/data/extracted/{id}/reject', description: 'help.apiGroups.publicApi.endpoints.reject' },
    ],
  },
  {
    title: 'help.apiGroups.facets.title',
    icon: 'mdi-tag-multiple',
    color: 'teal',
    note: 'help.apiGroups.facets.note',
    endpoints: [
      { method: 'GET', path: '/api/v1/facets/values', description: 'help.apiGroups.facets.endpoints.values' },
      { method: 'GET', path: '/api/v1/facets/types', description: 'help.apiGroups.facets.endpoints.types' },
      { method: 'GET', path: '/api/v1/facets/types/for-category/{id}', description: 'help.apiGroups.facets.endpoints.typesForCategory' },
      { method: 'GET', path: '/api/v1/facets/search', description: 'help.apiGroups.facets.endpoints.search' },
      { method: 'GET', path: '/api/v1/facets/entity/{id}/summary', description: 'help.apiGroups.facets.endpoints.entitySummary' },
      { method: 'GET', path: '/api/v1/facets/entity/{id}/referenced-by', description: 'help.apiGroups.facets.endpoints.referencedBy' },
      { method: 'POST', path: '/api/v1/facets/values', description: 'help.apiGroups.facets.endpoints.createValue' },
      { method: 'PUT', path: '/api/v1/facets/values/{id}/verify', description: 'help.apiGroups.facets.endpoints.verifyValue' },
    ],
  },
  {
    title: 'help.apiGroups.attachments.title',
    icon: 'mdi-paperclip',
    color: 'blue',
    note: 'help.apiGroups.attachments.note',
    endpoints: [
      { method: 'GET', path: '/api/v1/attachments/search', description: 'help.apiGroups.attachments.endpoints.search' },
      { method: 'POST', path: '/api/v1/entities/{id}/attachments', description: 'help.apiGroups.attachments.endpoints.upload' },
      { method: 'GET', path: '/api/v1/entities/{id}/attachments', description: 'help.apiGroups.attachments.endpoints.list' },
      { method: 'GET', path: '/api/v1/entities/{id}/attachments/{attachmentId}', description: 'help.apiGroups.attachments.endpoints.get' },
      { method: 'GET', path: '/api/v1/entities/{id}/attachments/{attachmentId}/download', description: 'help.apiGroups.attachments.endpoints.download' },
      { method: 'GET', path: '/api/v1/entities/{id}/attachments/{attachmentId}/thumbnail', description: 'help.apiGroups.attachments.endpoints.thumbnail' },
      { method: 'POST', path: '/api/v1/entities/{id}/attachments/{attachmentId}/analyze', description: 'help.apiGroups.attachments.endpoints.analyze' },
      { method: 'POST', path: '/api/v1/entities/{id}/attachments/{attachmentId}/apply-facets', description: 'help.apiGroups.attachments.endpoints.applyFacets' },
      { method: 'DELETE', path: '/api/v1/entities/{id}/attachments/{attachmentId}', description: 'help.apiGroups.attachments.endpoints.delete' },
    ],
  },
  {
